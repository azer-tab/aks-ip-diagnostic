...
from reports.json_validator import ReportValidator, save_json_report
...
def create_example_report():
    ...
    provisioning_issues = [
        ...
        create_issue(
            ...
            details={"error_code": "SubnetIsFull", "provisioning_state": "Failed"},
        ),
    ]
    ...
    ip_issues = [
        create_issue(
            ...
            details={"used_ips": 240, "available_ips": 11, "utilization_percentage": 95.6},
            remediation="Immediate action required: migrate to larger subnet",
        )
    ]

    builder.add_diagnostic_result(
        "ip_exhaustion", status="FAIL", risk_level="CRITICAL", issues=ip_issues
    )
    ...
    subnet_issues = [
        create_issue(
            ...
            affected_resource="systempool-sn",
            details={"recommended_headroom_percentage": 20, "actual_headroom_percentage": 4.4},
        )
    ]
    ...
    builder.add_diagnostic_result(
        ...
        details={"total_subnets_checked": 2, "capacity_warnings": 1},
    )
    ...
    builder.add_diagnostic_result(
        "max_pods", status="FAIL", risk_level="MEDIUM", issues=maxpods_issues
    )
    ...
    builder.add_node_pool(
        {
            ...
            "upgrade_settings": {"max_surge": "10%", "max_unavailable": 0},
            "ip_allocation": {
    ...
    builder.add_recommendation(
        create_recommendation(
            ...
            automation=False,
            docs=["https://docs.microsoft.com/azure/aks/configure-azure-cni#maximum-pods-per-node"],
        )
    )
    ...
    builder.add_recommendation(
        create_recommendation(
            ...
            automation=True,
            docs=["https://docs.microsoft.com/azure/aks/upgrade-cluster"],
        )
    )

    # Set summary
    builder.set_summary(overall_status="CRITICAL", risk_level="CRITICAL")
...
def main():
    ...
    success, message = save_json_report(
        report_data, "example_report.json", validate=True, enrich=True, pretty=True
    )
