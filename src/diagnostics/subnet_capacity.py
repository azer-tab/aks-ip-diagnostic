...
def calculate_required_ips(
    node_count: int, max_pods: int, autoscaling: bool = False, max_node_count: int | None = None
) -> dict[str, int]:
    """
...
def analyze_subnet_utilization(
    subnet_cidr: str, allocated_ips: int, future_required_ips: int = 0
) -> dict[str, any]:
    """
